...
public class ImageManagerTest {
    ...
    public void getArrayListFromStringTest(){
        ...
        Assert.assertTrue(msg.length() == 4000);

        ArrayList<String> list = ImageManager.getArrayListFromString(msg);
    ...
    public void resizeImageTest() throws IOException {
        ...
        Assert.assertTrue(img.getHeight() > 120 && img.getWidth() > 120);

        BufferedImage resImg = ImageManager.resizeImage(img);


        Assert.assertTrue(resImg.getHeight() <= 120 && resImg.getWidth() <= 120);
    }

    @Test
    public void getImageStringInListTest() throws IOException {
        ArrayList<String> imgs = ImageManager.getImageStringInList(URL);

        for (String msg : imgs){
            Assert.assertTrue(msg.length() <= 1000);
        }
